...
## Next steps
1. Create your own [policy](/docs/policies/)
2. Push your policy to a [registry](/docs/policies/lifecycle#policy-cli)
3. Update your [configuration file](/docs/getting-started/configuration) to point to your policy
4. Restart Topaz
