...
```bash
topaz configure <policy-name> -r <resource-url>
```

For example:

```
topaz configure policy-todo -r opcr.io/aserto-templates/policy-todo-rebac:1.0.0
```

After configuring Topaz, you can start the container with the following command:
