...
title: Signing policy images
description: How to sign policy images using cosign
---
...
```bash
$ cosign sign --key cosign.key registry.prod.aserto.com/omrigazitt1/peoplefinder:1.0.0
Enter password for private key: Pushing signature to: registry.prod.aserto.com/omrigazitt1/peoplefinder:sha256-05e6ed84d86f6a252e24f33cb12138d9193780f1d89a1b2ff14ced315fdf8481.sig
```
...
Verification for registry.prod.aserto.com/omrigazitt1/peoplefinder:1.0.0 --
