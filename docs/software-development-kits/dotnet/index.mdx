...
To add authentication to your backend application, first you need to create an Aserto [policy](/docs/policies/index) that contains the authentication rules for the APIs provided by the application.
