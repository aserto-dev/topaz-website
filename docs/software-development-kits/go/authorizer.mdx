...
[`AuthorizerClient`](https://github.com/aserto-dev/go-grpc-authz/blob/main/aserto/authorizer/authorizer/v1/authorizer_grpc.pb.go#L20) is the low-level interface that talks to the Topaz [authorization API](/docs/authorizer-guide/authz). It can be used on its own to make authorization calls or, more commonly, it can be used to create authorization middleware.
...
// TODO: Replace with call without tenant id and API key
