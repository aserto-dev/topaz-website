...
title: Display State Map
description: The Display State Map pattern
---
...
defines [decisions](/docs/policies/index.mdx#decision) called `visible` and `enabled`, which take on `true` / `false`
...
Topaz's [`decisiontree`](/docs/authorizer-guide/decisiontree) API makes it possible to compute these _display states_
...
The Topaz [JavaScript SPA SDK](/docs/software-development-kits/javascript/spa) and
